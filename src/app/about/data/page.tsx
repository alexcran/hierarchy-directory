...
export const metadata: Metadata = {
  title: 'Data Sources',
  description: 'Sources and methodology behind Hierarchy.Directory — Wikidata, Catholic-Hierarchy.org, the USCCB Directory, the Vatican Press Office, and diocesan records. Data is published under CC0.',
...
export default function DataSourcesPage() {
  return (
    <div className="mx-auto max-w-[700px] px-6 py-16 md:py-20">
      ...
      <h1 className="font-display text-5xl font-semibold text-text-primary mb-12 text-center md:text-6xl">
        Data Sources
      </h1>
      ...
      <Section title="How the data is maintained">
        <p>
          ...
          same goes for the death of a bishop. This is deliberate, considering that automated pipelines are good for
      ...
      <Section title="Sources we consult">
        <p className="leading-loose">
          ...
          {' · '}
          <a href="https://gavinr.com/catholic-dioceses-of-the-usa-map-updated/" target="_blank" rel="noopener noreferrer" className="text-burgundy hover:underline underline-offset-2">us_diocese_mapper (county-to-diocese mapping)</a>
        </p>
      </Section>
      ...
      <Section title="For diocesan representatives">
        ...
        <p>
          ...
          <a href="mailto:info@hierarchy.directory" className="text-burgundy hover:underline underline-offset-2">
            info@hierarchy.directory
          </a>with the subject &ldquo;Portrait Submission&rdquo; or &ldquo;Data Correction.&rdquo;
        </p>
      </Section>
