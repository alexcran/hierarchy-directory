...
export function TopBar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-white border-b border-border">
      <div className="relative h-full max-w-content mx-auto px-6 flex items-center justify-between">
        ...
        {pathname !== '/' && (
          <div className="absolute inset-x-0 flex justify-center pointer-events-none">
            <div ref={containerRef} className="relative w-full max-w-sm pointer-events-auto">
